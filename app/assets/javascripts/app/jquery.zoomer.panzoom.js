...
! function(a, b) {
    ...
    function g(a, c) {
        ...
        1 !== a.nodeType && b.error("Panzoom called on non-Element node"), b.contains(document, a) || b.error("Panzoom element must be attached to the document");
        var d = b.data(a, l);
        if (d) return d;
    ...
    if (a.PointerEvent) b.each(h, function(a, c) {
        ...
        var k = i.props;
        i.props = k.concat(["touches", "changedTouches", "targetTouches", "altKey", "ctrlKey", "metaKey", "shiftKey"]), i.filter = function(a, b) {
            var c, d = k.length;
    ...
    var l = "__pz__",
        ...
        r = "(\\-?[\\d\\.e]+)",
        s = "\\,?\\s*",
        t = new RegExp("^matrix\\(" + r + s + r + s + r + s + r + s + r + s + r + "\\)$");
    return e.prototype = {
        x: function(a) {
    ...
    }, g.rmatrix = t, g.events = b.pointertouch, g.defaults = {
        ...
        destroy: function() {
            this.disable(), b.removeData(this.elem, l)
        },
        resetDimensions: function() {
            ...
            var c, d = a.offset(),
                e = this.elem,
                f = this.$elem;
            this.isSVG ? (c = e.getBoundingClientRect(), c = {
                left: c.left - d.left,
                top: c.top - d.top,
                width: c.width,
                height: c.height,
            ...
            }, c.widthBorder = b.css(e, "borderLeftWidth", !0) + b.css(e, "borderRightWidth", !0) || 0, c.heightBorder = b.css(e, "borderTopWidth", !0) + b.css(e, "borderBottomWidth", !0) || 0, this.dimensions = c
        },
        reset: function(a) {
            a = d(a);
        ...
        transition: function(a) {
            if (this._transition)
                for (var c = a || !this.options.transition ? "none" : this._transition, d = this.$set, e = d.length; e--;) b.style(d[e], "transition") !== c && b.style(d[e], "transition", c)
        },
        pan: function(a, b, c) {
        ...
        zoom: function(a, c) {
            ...
            if (!d.disableZoom) {
                ...
                h[0] = a, h[3] = "number" == typeof d.dValue ? d.dValue : a, this.setMatrix(h, {
        ...
        _initStyle: function() {
            ...
            c.length && !b.nodeName(c[0], "body") && (a = {
                overflow: "hidden"
            }, "static" === c.css("position") && (a.position = "relative"), c.css(a))
        },
        ...
        _bind: function() {
            var a = this,
                c = this.options,
                d = c.eventNamespace,
                e = n ? "pointerdown" + d : "touchstart" + d + " mousedown" + d,
                f = n ? "pointerup" + d : "touchend" + d + " click" + d,
                h = {}, i = this.$reset,
                j = this.$zoomRange;
            if (b.each(["Start", "Change", "Zoom", "Pan", "End", "Reset"], function() {
            ...
            }), this.$elem.on(h), i.length && i.on(f, function(b) {
                ...
                })), j.length && (h = {}, h[(n ? "pointerdown" : "mousedown") + d] = function() {
                    a.transition(!0)
                }, h["change" + d] = function() {
                    a.zoom(+this.value, {
                        noSetRange: !0
        ...
        _trigger: function(a) {
            "string" == typeof a && (a = "panzoom" + a), this.$elem.triggerHandler(a, [this].concat(m.call(arguments, 1)))
        },
        _startMove: function(a, d) {
            ...
            n ? (f = "pointermove", g = "pointerup") : "touchstart" === a.type ? (f = "touchmove", g = "touchend") : (f = "mousemove", g = "mouseup"), f += p, g += p, this.transition(!0), this.panning = !0, this._trigger("start", a, d), d && 2 === d.length ? (h = this._getDistance(d), i = +q[0], j = this._getMiddle(d), e = function(a) {
                a.preventDefault();
                var b = m._getMiddle(d = a.touches),
                    c = m._getDistance(d) - h;
                m.zoom(c * (o.increment / 100) + i, {
                    focal: b,
                    matrix: q,
                    animate: !1
                }), m.pan(+q[4] + b.clientX - j.clientX, +q[5] + b.clientY - j.clientY, u), j = b
            }) : (k = a.pageX, l = a.pageY, e = function(a) {
                a.preventDefault(), m.pan(s + a.pageX - k, t + a.pageY - l, u)
            }), b(document).off(p).on(f, e).on(g, function(a) {
                a.preventDefault(), b(this).off(p), m.panning = !1, a.type = "panzoomend", m._trigger(a, q, !c(q, r))
            })
        }
    }, b.Panzoom = g, b.fn.panzoom = function(a) {
        var c, d, e, f;
        return "string" == typeof a ? (f = [], d = m.call(arguments, 1), this.each(function() {
            c = b.data(this, l), c ? "_" !== a.charAt(0) && "function" == typeof(e = c[a]) && void 0 !== (e = e.apply(c, d)) && f.push(e) : f.push(void 0)
