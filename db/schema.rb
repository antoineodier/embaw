...
ActiveRecord::Schema.define(version: 20150403223945) do
  ...
  create_table "transcriptions", force: :cascade do |t|
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
    t.string   "path_to_diplomatic_transcription"
    t.string   "path_to_normalized_transcription"
    t.string   "path_to_diplomatic_transformation"
    t.string   "path_to_normalized_transformation"
  end
